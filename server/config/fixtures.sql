...
INSERT INTO tb_service_type(service_created, service_name, service_description, service_active, service_fee)    VALUES (now(),'Bring Stuff','Main Function',true,1);
...
INSERT INTO tb_request_master(request_created,  request_created_by_user_id,  request_service_type_id,request_from_iso_country_id, request_to_iso_country_id,  request_from_city_location, request_to_city_location,request_from_pick_up_address,  request_from_pick_up_time,  request_from_post_code,request_to_deliver_address, request_weight_package,   request_description_package, request_duration_minutes,request_payment_money, request_currency_id ) VALUES (now(), 1, 1,1, 1, 'madrid', 'santander', 'calle 5', now() + interval '3 hour', 20080,'plaza 7','0.73','reloj complicado',100,  '13', 1 );
